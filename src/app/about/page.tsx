    ...
    <div className="max-w-[95vw] mx-auto py-16 md:py-32">
      ...
      <div className="mb-20 md:mb-32">
        ...
        <h1 className="text-[clamp(2.5rem,8vw,8rem)] font-bold uppercase tracking-tighter leading-[0.85] mb-8">
          THE <span className="text-accent">DEVELOPER</span>
          <br />BEHIND THE CODE
        </h1>
        <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground max-w-2xl leading-tight">
          ...
          solve real problems. I believe in clean code, thoughtful design, and
      ...
      <div className="bg-border grid grid-cols-1 md:grid-cols-2 gap-px mb-20 md:mb-32">
        <Card>
          ...
          <p className="text-lg text-muted-foreground group-hover:text-accent-foreground/70 transition-colors duration-300 mb-4">
            My journey into software engineering started with a simple curiosity:
            how do websites work? That question led me down a path of continuous
            learning.
          </p>
          <p className="text-lg text-muted-foreground group-hover:text-accent-foreground/70 transition-colors duration-300">
            Today, I focus on building production-grade web applications that
            combine modern frontend frameworks with robust backend architectures.
            I&apos;m particularly interested in AI-powered tools and creating
      ...
      <div className="mb-20 md:mb-32">
        ...
        <div className="space-y-0">
          {timeline.map((item, i) => (
            ...
            >
              <span className="text-[4rem] md:text-[6rem] font-bold leading-none tracking-tighter text-muted group-hover:text-accent transition-colors duration-300">
                {item.year}
              </span>
              <div>
